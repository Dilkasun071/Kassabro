      ...
      <div class="col-lg-12">
        <div class="latest_newsarea"> <span>Latest Post</span>
          <ul id="ticker01" class="news_sticker">
                <?php 
                $sql1 = "SELECT * FROM `tbl_upload` WHERE up_cat_id = 1 ORDER BY up_id DESC LIMIT 5";  
              ...
              <li><?php echo "<a href='".$url."'>";
              echo "<img src='img/".$row['up_img']."' style='width:100%;'>";echo $title;?></a></li>
            <?php 
               ?>
            <?php
                }
    ...
    <div class="row">
      <div class="col-lg-8">
        <div class="slick_slider">
            <?php 
            $sql1 = "SELECT * FROM `tbl_upload` WHERE up_cat_id = 2 ORDER BY up_id DESC LIMIT 4";  
            $result = mysqli_query($conn,$sql1);
            while ($row = mysqli_fetch_assoc($result)) {  
              $name = $row['up_cat_name'];
              $title = $row['up_title'];
            ...
            <?php
              ...
              $url = "single_page.php?cat={$cat}&item={$item}";?>
              <?php echo "<a href='".$url."'>";
              echo "<img src='img/".$row['up_img']."' style='width:100%;'>";echo $title;?></a>
        ...
        <div class="latest_post">
          ...
          <div class="latest_post_container">
            ...
            <ul class="spost_nav">
              <li>
                <?php 
                $sql1 = "SELECT * FROM `tbl_upload` ORDER BY up_id DESC LIMIT 6;";  
                $result = mysqli_query($conn,$sql1);
                while ($row = mysqli_fetch_assoc($result)) {  
                  $name = $row['up_cat_name'];
                  $title = $row['up_title'];
                ...
                <div class="media wow fadeInDown">
                  <?php
                   $cat = $row['up_cat_id'];
                    $item = $row['up_id'];
                    $url = "single_page.php?cat={$cat}&item={$item}";?>
                    <?php echo "<a href='".$url."' class='media-left'>";
                    echo "<img src='img/".$row['up_img']."' style='width:100%;'>";?></a>
                 
                  <div class="media-body"> <a href="single_page.php

" class="catg_title"><?php echo $title;?></a> </div>
                </div>
                <?php
                }
                ?>
      ...
      <div class="col-lg-8">
        <div class="left_content">
          <div class="single_post_content">
            <h2><span>Funny Video</span></h2>
            <div class="single_post_content_left">
              <ul class="spost_nav">
                <?php 
                $sql1 = "SELECT * FROM `tbl_upload` WHERE up_cat_id = 1 ORDER BY up_cat_id DESC LIMIT 2";  
                $result = mysqli_query($conn,$sql1);
                while ($row = mysqli_fetch_assoc($result)) {  
                  $name = $row['up_cat_name'];
                  $title = $row['up_title'];
                ...
                <div class="media wow fadeInDown">
                  <?php
                    ...
                    echo "<img src='img/".$row['up_img']."'  style='width:300px;height:180px;'>";?></a> 
                  <div class="media-body"> <a href="single_page.php

" class="catg_title"> </div>
                  <h4><?php echo $title;?></h4></a>
                </div>
                <?php
                }
            ...
            <div class="single_post_content_right">
              <ul class="spost_nav">
                <?php 
                $sql1 = "SELECT * FROM `tbl_upload` WHERE up_cat_id = 1 LIMIT 5";  
                $result = mysqli_query($conn,$sql1);
                while ($row = mysqli_fetch_assoc($result)) {  
                  $name = $row['up_cat_name'];
                  $title = $row['up_title'];
          ...
          <div class="fashion_technology_area">
            <div class="fashion">
              <div class="single_post_content">
                ...
                <ul class="spost_nav">
                <?php 
                $sql1 = "SELECT * FROM `tbl_upload` WHERE up_cat_id = 3 ORDER BY up_cat_id DESC LIMIT 1";  
                $result = mysqli_query($conn,$sql1);
                while ($row = mysqli_fetch_assoc($result)) {  
                  $name = $row['up_cat_name'];
                  $title = $row['up_title'];
                ...
                <div class="media wow fadeInDown">
                  <?php 
                    echo "<a href='".$url."' class='media-left'>";
                    echo "<img src='img/".$row['up_img']."' style='width:300px;height:180px;'>";  
                    echo "<a href='".$url."' class=''>";echo $title;?></a>
                </div>
                  <h4><?php echo $title;?></h4></a>
                </div>
                ...
                <ul class="spost_nav">
                  <?php 
                    $sql1 = "SELECT * FROM `tbl_upload` WHERE up_cat_id = 3 LIMIT 5 ";  
                    $result = mysqli_query($conn,$sql1);
                    while ($row = mysqli_fetch_assoc($result)) {  
                      $name = $row['up_cat_name'];
                      $title = $row['up_title'];
            ...
            <div class="technology">
              <div class="single_post_content">
                <h2><span>Helath & Care</span></h2>
                <ul class="spost_nav">
                  <?php 
                  $sql1 = "SELECT * FROM `tbl_upload` WHERE up_cat_id = 2 ORDER BY up_id DESC LIMIT 1";  
                  $result = mysqli_query($conn,$sql1);
                  while ($row = mysqli_fetch_assoc($result)) {  
                    $name = $row['up_cat_name'];
                    $title = $row['up_title'];
                ...
                <div class="media wow fadeInDown">
                  <?php 
                    echo "<a href='".$url."' class='media-left'>";echo "<img src='img/".$row['up_img']."' style='width:300px;height:180px;'>";echo $title;?></a>
                </div>
                  <?php
                  }
                  ?>
                ...
                <ul class="spost_nav">
                  <li>
                  <?php 
                    $sql1 = "SELECT * FROM `tbl_upload` WHERE up_cat_id = 2 LIMIT 5";  
                    $result = mysqli_query($conn,$sql1);
                    while ($row = mysqli_fetch_assoc($result)) {  
                      $name = $row['up_cat_name'];
                      $title = $row['up_title'];
        ...
        <aside class="right_content">
          <div class="single_sidebar">
            ...
            <ul class="spost_nav">
                ...
                <div class="media wow fadeInDown">
                <li><?php echo "<a href='".$url."'>";echo "<img src='img/".$row['up_img']."' style='width:100%;'>";echo $title;?></a></li>
                </div>
                  <?php
                  }
                  ?>
